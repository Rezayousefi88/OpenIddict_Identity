        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ename = table.Column<string>(maxLength: 50, nullable: true),
                    StateCode = table.Column<long>(nullable: false),
                    Pelak = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    EmployCode = table.Column<string>(unicode: false, maxLength: 10, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    BaseTruckRent = table.Column<long>(nullable: true),
                    SourceCityID = table.Column<int>(nullable: true),
                    DestinationCityID = table.Column<int>(nullable: true),
                    CreateDate = table.Column<DateTime>(type: "datetime", nullable: true),
                    LoadDate = table.Column<string>(maxLength: 50, nullable: true),
                    LoadTime = table.Column<string>(maxLength: 50, nullable: true),
                    ExpireDate = table.Column<string>(maxLength: 50, nullable: true),
                    ExpireTime = table.Column<string>(maxLength: 50, nullable: true),
                    GoodName = table.Column<string>(maxLength: 50, nullable: true),
                    PackageType = table.Column<int>(nullable: true),
                    TruckType = table.Column<int>(nullable: true),
                    LoaderType = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Freight_Loader",
                        column: x => x.LoaderType,
                        principalTable: "Loader",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Freight_PackageType",
                        column: x => x.PackageType,
                        principalTable: "PackageType",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Freight_TruckType",
                        column: x => x.TruckType,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employ_PersonId",
                table: "Employ",
                column: "PersonId");

            migrationBuilder.CreateIndex(
                name: "IX_Freight_LoaderType",
                table: "Freight",
                column: "LoaderType");

            migrationBuilder.CreateIndex(
                name: "IX_Freight_PackageType",
                table: "Freight",
                column: "PackageType");

            migrationBuilder.CreateIndex(
                name: "IX_Freight_TruckType",
                table: "Freight",
                column: "TruckType");
